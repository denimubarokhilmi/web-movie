  ...
  <section class="container-fluid bg-black p-1">
    ...
    <div class="page-new-relase container-md mt-2">
      ...
      <h2 class="section-title">
        <span class="highlight">Top Rating</span>
      </h2>
      <div
        ref="topRating"
...
const getMovie = (async () => {
  try {
    ...
    getUI(topRating, result.results);
  } catch (error) {
    console.log(error);
  }
})();
...
function colContent(element) {
  return `<div class="card card-relase  bg-transparent border border-0  mt-3 ">
          ...
          alt="Card image">
                  ...
                  <button class="watch-trailler-topRated btn btn-danger" data-idMovie="${
                    element.id
